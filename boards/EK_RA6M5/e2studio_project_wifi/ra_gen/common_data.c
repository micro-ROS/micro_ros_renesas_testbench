...
const uart_cfg_t g_uart0_cfg = { .channel = 9, .data_bits = UART_DATA_BITS_8,
		.parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
				rm_wifi_onchip_silex_uart_callback, .p_context = NULL,
...
#define RA_NOT_DEFINED (1)
				...
				.sntp_enabled =
						(wifi_onchip_silex_sntp_enable_t) WIFI_ONCHIP_SILEX_CFG_SNTP_ENABLE,
				.sntp_server_ip = (uint8_t*) "0.0.0.0",
				.sntp_timezone_offset_from_utc_hours = 0,
				.sntp_timezone_offset_from_utc_minutes = 0,
				.sntp_timezone_use_daylight_savings =
						(wifi_onchip_silex_sntp_daylight_savings_enable_t) 0,
